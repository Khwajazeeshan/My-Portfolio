...
const VoiceChatButton = ({ setInputValue }) => {
    ...
    return (
        ...
        >
            {listening ? (
                <span className="voice-spinner" style={{ width: 24, height: 24, border: "3px solid #fff", borderTop: "3px solid #ff4500", borderRadius: "50%", animation: "spin 1s linear infinite" }} />
            ) : (
                <svg
                    width="24"
                    height="24"
